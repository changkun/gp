...
def main():
    ...
    input_mesh_mat  = './assets/texture.png'
    input_mesh_tri  = './assets/bunny.obj'
    input_mesh_quad = './assets/bunny_quad.obj'
...
if __name__ == '__main__':
    ...
    if major == 2 and minor == 93 and patch >= 1:
        start = time.time()
        main()
